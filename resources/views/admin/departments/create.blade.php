        ...
        <div class="item-wrapper">
            <div class="item">
                <div class="mb-3">
                    ...
                    <input type="text" name="name_en[]" required="required" placeholder="English Name" class="form-control" />
                </div>

                <div class="mb-3">
                    <label>Arabic Name</label>
                    <input type="text" name="name_ar[]" required="required" placeholder="Arabic Name" class="form-control" />
                </div>
            </div>
